...
namespace excelapp
{
    public class ItemBoxElement
    {
        ...
        public void Destroy()
        {
            m_form.Controls.Remove(m_knobLabel); m_knobLabel = null;
            m_form.Controls.Remove(m_textBox);   m_textBox = null;
            m_form.Controls.Remove(m_upButton);  m_upButton = null;
            m_form.Controls.Remove(m_dwnButton); m_dwnButton = null;
        }
