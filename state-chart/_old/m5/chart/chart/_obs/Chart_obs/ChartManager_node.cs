...
public partial class ChartManager_obs
{
    public class Node
    {
        ...
        public Point         buf_dstpoint  { get { return DrawUtil_obs.Add_X(dstpoint,-ARROW_BUFFER);    } } //緩衝付
        ...
        public Point         buf_srcpoint_next { get { return DrawUtil_obs.Add_X(srcpoint_next,ARROW_BUFFER); } } //緩衝付     
        ...
        public Point         buf_srcpoint_branch(int i) { return DrawUtil_obs.Add_X(srcpoint_branch(i),ARROW_BUFFER); } //緩衝付 
        ...
        public  Rectangle  bounding
        {
            get {
                if (_bounding==null)
                {
                    ...
                    {
                        newrect = RectUtil_obs.Add(newrect, get_branch_text_rect(i));
                    }
                    _bounding = newrect;
                }
