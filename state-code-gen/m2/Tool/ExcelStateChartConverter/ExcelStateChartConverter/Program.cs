...
namespace ExcelStateChartConverter
{
    class Program
    {
        ...
        static void Main(string[] args)　// 0 --- excel file, 1 --- output dir
        {
            ...
            src = (bVba ? "'" : "//" ) +  " This source is created by ExcelStateChartConverter.exe. Source : " + args[0] + "\n" + src;
           
            
            File.WriteAllText(Path.Combine(args[1],filename),src,(bVba ? Encoding.GetEncoding("shift-jis") : Encoding.UTF8));
        }
