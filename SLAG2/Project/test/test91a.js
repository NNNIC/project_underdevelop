...
function S_Q_START(bFirst)
{
    if (bFirst) {
        ...
        while (true) {
            s_number = UnityEngine.Mathf.Ceil(UnityEngine.Random.Range(100, 1000));
            var n3 = s_number % 10;
            var n2 = UnityEngine.Mathf.Ceil(s_number / 10) % 10;
            var n1 = UnityEngine.Mathf.Ceil(s_number / 100);
