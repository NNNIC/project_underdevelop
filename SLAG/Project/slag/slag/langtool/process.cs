...
namespace langtool
{
    public class process
    {
        public static void Run(string src, bool bCompileOnly=false,string outbinfile = null)
        {
            ...
            //SAVE
            YSAVELOAD.Save(executable_value_list,langtool.runtime.CFG.TMPBIN);
            if (outbinfile!=null)
            {
            ...
            { 
                //LOAD
                executable_value_list = YSAVELOAD.Load(langtool.runtime.CFG.TMPBIN);
        ...
        public static void Run_from_savefile(string file = null)
        {
            if (file==null)
            {
                file = langtool.runtime.CFG.TMPBIN;
            }
